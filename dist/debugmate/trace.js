...
function _trace() {
  _trace = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(error, domain, token) {
    var sources, files, previews;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          files = sources.map(function (_ref) {
            var file = _ref.file,
              line = _ref.line;
            return {
              path: file,
          ...
          _context.next = 7;
          return getCodePreviewFromAPI(domain, token, files);
        case 7:
        ...
        case 11:
          ...
          console.error('Error while parsing stack trace:', _context.t0);

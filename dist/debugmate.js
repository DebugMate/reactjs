...
var _require2 = require('./debugmate/errorHandlerSetup'),
  setupErrorHandling = _require2.setupErrorHandling,
  cleanupErrorHandling = _require2.cleanupErrorHandling;
var _require3 = require('./debugmate/api'),
  sendErrorToAPI = _require3.sendErrorToAPI;
var _require4 = require('./debugmate/trace'),
  trace = _require4.trace;
...
var Debugmate = /*#__PURE__*/function () {
  ...
  return _createClass(Debugmate, [{
    ...
    key: "publish",
    value: (function () {
      var _publish = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(error) {
        var userContext,
          environmentContext,
          request,
          _traceData$,
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              userContext = _args.length > 1 && _args[1] !== undefined ? _args[1] : null;
              environmentContext = _args.length > 2 && _args[2] !== undefined ? _args[2] : null;
              request = _args.length > 3 && _args[3] !== undefined ? _args[3] : null;
              if (this.isPublishingAllowed(error)) {
                _context.next = 5;
                break;
              }
            ...
            case 5:
              ...
              _context.prev = 8;
              _context.next = 11;
              return trace(error, this.domain, this.token);
            case 11:
              traceData = _context.sent;
              data = _objectSpread({
                exception: error.name,
                message: error.message,
                file: ((_traceData$ = traceData[0]) === null || _traceData$ === void 0 ? void 0 : _traceData$.file) || 'unknown',
                type: 'web',
                trace: traceData
              }, this.context.payload());
              _context.next = 15;
              return sendErrorToAPI(this.domain, this.token, data);
            case 15:
              _context.next = 20;
              break;
            case 17:
              ...
              console.error('Error preparing payload:', _context.t0);
            case 20:
            case "end":

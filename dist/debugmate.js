...
var _require = require('./stackTraceParser'),
...
*/
var Debugmate = /*#__PURE__*/function () {
  function Debugmate() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    _classCallCheck(this, Debugmate);
  ...
  return _createClass(Debugmate, [{
    ...
    key: "publish",
    value: function publish(error) {
      var userContext = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
      var environmentContext = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      ...
      var requestPayload = this.context.appRequest();
      var data = this.payload(error, requestPayload);
      fetch("".concat(this.domain, "/api/capture"), {
        method: 'POST',
        headers: {
        ...
        return console.error('Debugmate error:', err);
      });
    }
    ...
    key: "isPublishingAllowed",
    value: function isPublishingAllowed(error) {
    ...
    key: "handleResponse",
    value: (function () {
      var _handleResponse = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(response) {
        var text, data;
    ...
    */
    ...
    key: "cleanupGlobalErrorHandling",
    value: function cleanupGlobalErrorHandling() {
    ...
    key: "payload",
    value: function payload(error, request) {
      var _trace$;
      var trace = this.trace(error);
      var data = _objectSpread({
        exception: error.name,
        message: error.message,
        file: ((_trace$ = trace[0]) === null || _trace$ === void 0 ? void 0 : _trace$.file) || 'unknown',
        type: 'web',
        trace: trace
    ...
    key: "trace",
    value: function trace(error) {
      var stackTrace = parse(error);
      if (!stackTrace.sources || stackTrace.sources.length === 0) {
        return [];
      }
      return stackTrace.sources.map(function (source) {
        return {
          file: source.file,
          line: source.line,
...
_defineProperty(Debugmate, "instance", null);
